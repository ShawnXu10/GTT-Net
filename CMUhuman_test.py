...
filename = os.listdir('CMU_human/data')
for imotion in range(len(filename)):
    structdata_test = DeepDyn.DynStructDataset(json_file='CMU_human/data/'+filename[imotion],BatchSize = 40,Knn = 20,train = 'Test', order = 1, transform = DeepDyn.ToTensor())
